...
// I2C Controller
// ============================================================
// This module implements low-level I2C/SCCB communication
// for configuring the OV7670 camera.
//
// Features:
...
//
// Author notes:
// - SCCB protocol of OV7670 is very similar to I2C
// - Timing controlled by external I2C_CLK
// ============================================================
...
(
    ...
    input               I2C_CLK,   // I2C transfer clock
    input               I2C_EN,    // data update enable
    ...
    output              ACK,       // ACK detected
    output reg          END,       // transfer finished
...
// Current SDA output bit
reg I2C_BIT;

// Internal SCL control
reg SCLK;

// State counter for transaction steps
reg [5:0] SD_COUNTER;
...
// 0 = input mode (High-Z)
//
// During ACK cycles we release SDA
// so the slave can drive the line.
// ============================================================

wire SDO1 =
    (
        (SD_COUNTER == 13 || SD_COUNTER == 14) ||
        (SD_COUNTER == 24 || SD_COUNTER == 25) ||
...
begin
    ...
    begin
        ...
        begin
            ...
            // =================================================
            // READ MODE NOT COMMENTED HERE
            // (same structure as write mode)
            // =================================================
