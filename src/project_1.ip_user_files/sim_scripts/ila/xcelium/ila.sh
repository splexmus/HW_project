...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../vivado/2025.2/data/rsb/busdef" +incdir+"../../../../project_1.gen/sources_1/ip/ila/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../vivado/2025.2/data/rsb/busdef" +incdir+"../../../../project_1.gen/sources_1/ip/ila/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/splexmus/Documents/Basys3-Camera/src/project_1.cache/compile_simlib/xcelium"
  fi
