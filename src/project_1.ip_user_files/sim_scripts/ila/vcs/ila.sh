...
#
# Script generated by Vivado on Sat Apr 11 11:47:41 +07 2026
...
# script info
echo -e "ila.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../vivado/2025.2/data/rsb/busdef" +incdir+"../../../../project_1.gen/sources_1/ip/ila/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../vivado/2025.2/data/rsb/busdef" +incdir+"../../../../project_1.gen/sources_1/ip/ila/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/splexmus/Documents/Basys3-Camera/src/project_1.cache/compile_simlib/vcs"
  fi
